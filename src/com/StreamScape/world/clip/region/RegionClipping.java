package com.StreamScape.world.clip.region;
...
import com.StreamScape.world.clip.stream.ByteStream;
import com.StreamScape.world.entity.impl.Character;

/**
 * A highly modified version of the released clipping.
 * 
 * @author Relex lawl and Palidino: Gave me (StreamScape) the base.
 * @editor StreamScape: Rewrote the system, now loads regions when they're actually
 *         needed etc.
 */
