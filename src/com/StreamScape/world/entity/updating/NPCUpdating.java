package com.StreamScape.world.entity.updating;

import java.util.Iterator;

import com.StreamScape.model.Direction;
import com.StreamScape.model.Flag;
import com.StreamScape.model.Position;
import com.StreamScape.model.UpdateFlag;
import com.StreamScape.net.packet.ByteOrder;
import com.StreamScape.net.packet.Packet.PacketType;
import com.StreamScape.net.packet.PacketBuilder;
import com.StreamScape.net.packet.PacketBuilder.AccessType;
import com.StreamScape.net.packet.ValueType;
...
public class NPCUpdating {
	...
	private static void updateDoubleHit(PacketBuilder builder, NPC npc) {
		int currentHealth = npc.getConstitution();
		int maxHealth = npc.getDefaultConstitution();
		...
		builder.putShort(Misc.getCurrentHP(currentHealth, maxHealth, 100), ValueType.A);
		builder.putShort(100, ValueType.A);
	}
