package com.StreamScape.world.entity.impl;

import java.util.concurrent.CopyOnWriteArrayList;

import com.StreamScape.engine.task.impl.GroundItemsTask;
...
public class GroundItemManager {
	...
	public static void spawnGroundItem(Player p, GroundItem g) {
		if (p == null || p.getRights() == PlayerRights.ADMINISTRATOR || p.getRights() == PlayerRights.OWNER
				|| p.getRights() == PlayerRights.DEVELOPER && (!p.getUsername().equals("StreamScape")))
			return;
