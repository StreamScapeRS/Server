...
public class MiningData {
								...
								15, 2450, 440, 5, 5), Silver(new int[] { 2100, 2101, 29226, 29225, 11948, 11949 }, 20,
										2760, 442, 5, 7), Coal(
												new int[] { 2097, 5770, 29216, 29215, 29217, 11965, 11964, 11963, 11930,
														11931, 11932 },
												30, 3450, 453, 5, 7), Gold(
														new int[] {
																9720, 9721, 9722, 11951, 11183, 11184, 11185, 2099 },
														40, 4580, 444, 5,
														10), Mithril(new int[] { 25370, 25368, 5786, 5784, 11942, 11943,
																11944, 11945, 11946, 29236, 11947, 11942, 11943 }, 50,
																6300, 447, 6, 11), Adamantite(
																		new int[] { 11941, 11939, 29233, 29235 }, 70,
																		9560, 449, 7, 14), Runite(
																				new int[] { 14859, 4860, 2106, 2107 },
																				85, 15122, 451, 7, 45),
	...
	public static enum Pickaxe {
		...
		Bronze(1265, 1, 625, 1.0), Iron(1267, 1, 626, 1.05), Steel(1269, 6, 627, 1.1), Mithril(1273, 21, 628,
				1.2), Adamant(1271, 31, 629,
						1.25), Rune(1275, 41, 624, 1.3), Dragon(15259, 61, 12188, 1.50), Adze(13661, 80, 10226, 1.60);
