...
import com.StreamScape.engine.task.impl.HunterTrapsTask;
...
public class Hunter {
	...
	private static final int[] exps = { 34*2*100, 47*2*100, 61*2*100, 65*2*100, 95*2*100, 199*2*100, 199*2*100, 265*2*100 };
