...
import com.StreamScape.world.content.skill.impl.runecrafting.RunecraftingData.TalismanData;
...
public class Runecrafting {
	...
	public static void craftRunes(final Player player, RunecraftingData.RuneData rune) {
		...
		Achievements.doProgress(player, AchievementData.CRAFT_SOME_RUNES);
		Achievements.doProgress(player, AchievementData.CRAFT_50_RUNES);
		Achievements.doProgress(player, AchievementData.CRAFT_500_RUNES);
