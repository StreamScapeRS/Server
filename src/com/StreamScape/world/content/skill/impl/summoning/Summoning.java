...
import com.StreamScape.world.content.skill.impl.summoning.BossPets.BossPet;
...
public class Summoning {
	...
	public void processFamiliar() {
		...
		TaskManager.submit(new Task(1, n, true) {
			...
			protected void execute() {
				...
				if (!familiar.isPet() && (!(CustomPet.isCustomFamiliar(familiar)))) {
					if (clockTimer >= 2) {
	...
	public boolean summon(final FamiliarData familiar, boolean renew, boolean login) {
		if (familiar == null)
			return false;
