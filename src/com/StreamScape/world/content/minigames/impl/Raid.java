...
public abstract class Raid extends Minigame {
    protected Stage[] stages;
    protected int currentStage = -1;


    protected Position endPos = new Position(3095, 2990, 0);

    // delays
    public static final int START_DELAY = 120; // 120 seconds
    public static final int NEXT_STAGE_DELAY = 20; // 20 seconds
