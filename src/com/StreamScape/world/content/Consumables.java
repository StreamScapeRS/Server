...
import com.StreamScape.engine.task.impl.PoisonImmunityTask;
...
public class Consumables {
	...
	private enum FoodType {
		...
		KEBAB(new Item(1971), 40), CHEESE(new Item(1985), 45), CAKE(new Item(1891), 50), SECOND_CAKE_SLICE(
				new Item(1893),
				50), THIRD_CAKE_SLICE(new Item(1895), 50), BANDAGES(new Item(14640), 4000), JANGERBERRIES(new Item(247),
	...
	public static int getBoostedStat(Player player, int skillId, boolean sup, boolean combatPotion) {
		...
		if (sup)
			...
			increaseBy = (int) (player.getSkillManager().getMaxLevel(skill) * (combatPotion ? 0.10D : 0.13D)) + 1;
