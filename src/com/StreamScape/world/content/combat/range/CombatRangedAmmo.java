package com.StreamScape.world.content.combat.range;
...
public class CombatRangedAmmo {
	...
	public enum AmmunitionData {
		...
		THUNDER_SHOT(new int[] { -3 }, 1730, 1231, 3, 33, 70, 43, 31, 1730),
	...
	public enum RangedWeaponData {
		...
		ICE_GUN(new int[] { 21080 }, new AmmunitionData[] {AmmunitionData.ICE_BALL},
				RangedWeaponType.CROSSBOW),
		...
		public static AmmunitionData getAmmunitionData(Player p) {
			...
			if (data != null) {
				...
				if (p.getRangedWeaponData() == RangedWeaponData.ICE_GUN) {
					return AmmunitionData.ICE_BALL;
				}
