...
import com.StreamScape.world.content.combat.range.CombatRangedAmmo.AmmunitionData;
import com.StreamScape.world.content.combat.range.CombatRangedAmmo.RangedWeaponData;
import com.StreamScape.world.content.combat.range.CombatRangedAmmo.RangedWeaponType;
...
public class DefaultRangedCombatStrategy implements CombatStrategy {
	...
	public static void decrementAmmo(Player player, Position pos) {
		...
		int[] buggedGuns = {423, 601, 422, 21025, 21005, 21045,21080};
		...
		if (entity.isNpc()) {
			...
			switch (npc.getId()) {
				...
				case 1200:
					...
					break;
				case 1204:
					ammo = AmmunitionData.ADAMANT_ARROW;
					break;
				case 1202:
					ammo = AmmunitionData.ICE_ARROW;
break;
			}
