	...
	public static Dialogue get(Player p, int stage) {
			...
			dialogue = new Dialogue() {
				...
				public String[] dialogue() {
					return new String[] { "You can earn money doing many different things in",
							"StreamScape. For example, see those Thieving stalls infront of ",
			...
			dialogue = new Dialogue() {
				...
				public String[] dialogue() {
					return new String[] { "Enough of the boring stuff, let's show you some creatures!",
							"There are a bunch of bosses to fight in StreamScape.",
		...
		case 8:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[] { "StreamScape also has a lot of enjoyable minigames.",
		...
		case 11:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[] { "StreamScape is a competitive game. Next to you is a scoreboard",
			...
			dialogue = new Dialogue() {
				...
				public String[] dialogue() {
					return new String[] { "If you have any more questions, simply use the ::help",
							...
							"other players for help there too. Have fun playing StreamScape!" };
				}
					...
					if (ConnectionHandler.getStarters(p.getHostAddress()) <= GameSettings.MAX_STARTERS_PER_IP) {
						if (p.getGameMode() != GameMode.NORMAL) {
							p.getInventory().add(995, 10000).add(1153, 1).add(1115, 1).add(1067, 1).add(1323, 1)
									...
									.add(11118, 1).add(1007, 1).add(1061, 1).add(330, 100).add(1419, 1);
						} else {
							p.getInventory().add(995, 5000000).add(1153, 1).add(1115, 1).add(1067, 1).add(1323, 1)
									...
									.add(11118, 1).add(1007, 1).add(1061, 1).add(386, 100).add(1419, 1);
						}
